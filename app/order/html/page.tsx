          ...
          <div className="flex flex-wrap mb-24 -mx-4">
            ...
            <div className="w-full px-4 md:w-1/2">
              <div className="lg:pl-20">
                    ...
                    <div className="grid grid-cols-2 gap-4 pb-4 mt-2 mb-4 border-b-2 border-gray-300 lg:grid-cols-3">
                      <div>
                        <button
                          ...
                          onClick={() => {
                            handleButtonClick({ newPrice: 1900, newDays: 10 });
                            setActiveButton(1);
                          }}
                        >
                          <div>
                      ...
                      <div>
                        <button
                          ...
                          onClick={() => {
                            handleButtonClick({ newPrice: 3000, newDays: 15 });
                            setActiveButton(2);
                          }}
                        >
                          {" "}
                      ...
                      <div>
                        <button
                          ...
                          onClick={() => {
                            handleButtonClick({ newPrice: 5000, newDays: 20 });
                            setActiveButton(3);
                          }}
                        >
                          {" "}
                      ...
                      <div>
                        <button
                          ...
                          onClick={() => {
                            handleButtonClick({ newPrice: 7000, newDays: 25 });
                            setActiveButton(4);
                          }}
                        >
                          {" "}
                ...
                <div className="mt-6 ">
                  <Form price={price} product={"HTML Business Website"} />
                </div>
              </div>
            </div>
          </div>
