      ...
      <section className="bg-background">
        <div className="grid container px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-accent rounded-lg border  border-accent hover:bg-accent hover:text-accent-foreground focus:ring-4 focus:ring-accent focus:ring-opacity-50 transition-all duration-3"
            >
            ...
            <Link
              href="/portfolio"
              className="md:inline-flex hidden  items-center justify-center px-5 py-3 text-base font-medium text-center text-accent-foreground border border-accent rounded-lg hover:bg-accent hover:text-accent-foreground focus:ring-4 focus:ring-accent focus:ring-opacity-50 transition-all duration-3"
            >
              Our Portfolio
            </Link>
          </div>
