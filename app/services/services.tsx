    ...
    <main className="w-full flex flex-col items-center py-8 md:py-12">
      <div className="container px-4 md:px-6">
        ...
        <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center mt-10">
          <Link
            className="inline-flex h-10 hover:shadow-lg hover:text-accent_hover items-center justify-center rounded-md bg-gray-900 px-8 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300"
            href="/contact"
          >
            Contact Us
          </Link>
          <Link
            className="inline-flex text-white bg-accent h-10 items-center justify-center rounded-md border border-gray-200 px-8 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50  dark:bg-accent dark:hover:bg-accent-hover "
            href="/portfolio"
          >
            View Portfolio
          </Link>
